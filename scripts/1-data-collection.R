...
library(ggplot2); theme_set(theme_bw()) # Help visualize the data (set theme to theme_bw()) 
...
# Print a summary of each file, showing the number of rows and columns in the data, 
# as well as the data types of each column
str(trip_01)
str(trip_02)
str(trip_03)
str(trip_04)
