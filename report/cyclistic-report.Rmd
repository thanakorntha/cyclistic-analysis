...
## Bike Usage between Casual Riders and Annual Members
...
plot_08 +
  ...
  geom_hline(yintercept = median(trip_data_v2$ride_length), color = "darkgray", linetype = "dashed", size = 0.50) +
  annotate("text", label = "Median = 10.52", x = 12, y = median(trip_data_v2$ride_length), vjust = -1, hjust = 0.75, size = 2.50, color = "darkgray")
```
...
plot_09
  ...
  # annotate("segment", x = 7, y = 300000, xend = 7, yend = 350000, arrow = arrow(type = "closed", length = unit(0.02, "npc")))
```
