...
# Load 'scales' function for visualization
library(scales)
...
trip_data_v2 %>%
  summarize(mean = mean(ride_length), 
            ...
            sd = sd(ride_length), 
            count = n()) %>% 
  knitr::kable("simple", caption = "A statistical summary of the duration of rides in the Cyclistic's historical trip data")
```
...
ggplot(ride_length_user, aes(x = member_casual, y = mean_ride_length, fill = member_casual)) + 
  ...
  labs(
    x = "User Type", 
    y = "Average Ride Length in min", 
    title = "Average ride length in minute by user type", 
    subtitle = "Data from January 2022 to December 2022", 
    caption = "Source: Cyclistic dataset"
  ) + 
  theme(
...
ggplot(ride_length_user_day, aes(x = day_of_week, y = mean_ride_length, fill = member_casual)) + 
  ...
  labs(
    x = "Day", 
    y = "Average Ride Length in min", 
    title = "Average ride length in minute by user type each day", 
    subtitle = "Data from January 2022 to December 2022", 
    caption = "Source: Cyclistic dataset"
  ) + 
  theme(
...
ggplot(ride_length_user_month, aes(x = month, y = mean_ride_length, group = member_casual)) + 
  ...
  labs(
    x = "Month", 
    y = "Average Ride Length in min", 
    title = "Average ride length in minute by user type each month", 
    subtitle = "Data from January 2022 to December 2022", 
    caption = "Source: Cyclistic dataset"
  ) + 
  theme(
...
ggplot(ride_count_user, aes(x = member_casual, y = ride_count, fill = member_casual)) + 
  geom_bar(stat = "identity", color = "black") + 
  expand_limits(y = c(0, 3500000)) + 
...
ggplot(ride_count_user_day, aes(x = day_of_week, y = ride_count, fill = member_casual)) + 
  ...
  labs(
    x = "Day", 
    y = "Number of Rides", 
    title = "Number of rides by user type each day", 
    subtitle = "Data from January 2022 to December 2022", 
    caption = "Source: Cyclistic dataset"
  ) + 
  theme(
...
ggplot(ride_count_user_month, aes(x = month, y = ride_count, group = member_casual)) + 
  ...
  labs(
    x = "Month", 
    y = "Number of Rides", 
    title = "Number of rides by user type each month", 
    subtitle = "Data from January 2022 to December 2022", 
    caption = "Source: Cyclistic dataset"
  ) + 
  theme(
